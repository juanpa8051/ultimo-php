...
<div class="mb-3 row">
<label for="inputPassword" class="col-sm-2 col-form-label">primer numero</label>
<div class="col-sm-4">
...
<div class="mb-3 row">
<label for="inputPassword" class="col-sm-2 col-form-label">segundo numero</label>
<div class="col-sm-6">
  <input type="number" class="form-control" id="num2" name = "num2">
    ...
    <input type="number" class="form-control" id="" name = "" value="<?php echo $suma ;?>">
</form>
